...
Let's load back up our data from the previous lessons on R by Adriana Picoral and from Kathryn Busby on ggplot2. I'll name the dataframe `avocado` because I can't remember what the other instructors named their data. We will also load our packages here. 
...
regions <- c("West","Southeast","SouthCentral","Plains","Northeast","Midsouth",
             "GreatLakes","WestTexNewMexico","NorthernNewEngland")
